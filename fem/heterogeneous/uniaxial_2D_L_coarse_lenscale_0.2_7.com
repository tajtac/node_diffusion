...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.2_7',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.2_7',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a417.rcac.purdue.edu', 'brown-a417', '172.18.33.212'),
    'mp_host_list':(('brown-a417.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
