...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.4_3',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.4_3',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a027.rcac.purdue.edu', 'brown-a027', '172.18.32.77'),
    'mp_host_list':(('brown-a027.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
