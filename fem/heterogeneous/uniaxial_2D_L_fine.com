...
options = {
    ...
    'input':'uniaxial_2D_L_fine',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_fine',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a013.rcac.purdue.edu', 'brown-a013', '172.18.32.63'),
    'mp_host_list':(('brown-a013.rcac.purdue.edu', 6),),
    'mp_mode':MPI,
