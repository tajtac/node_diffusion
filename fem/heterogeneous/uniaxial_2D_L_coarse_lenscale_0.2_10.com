...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.2_10',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.2_10',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a026.rcac.purdue.edu', 'brown-a026', '172.18.32.76'),
    'mp_host_list':(('brown-a026.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
