...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.4_10',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.4_10',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a239.rcac.purdue.edu', 'brown-a239', '172.18.33.34'),
    'mp_host_list':(('brown-a239.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
