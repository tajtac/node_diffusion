...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.2_1',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.2_1',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a406.rcac.purdue.edu', 'brown-a406', '172.18.33.201'),
    'mp_host_list':(('brown-a406.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
