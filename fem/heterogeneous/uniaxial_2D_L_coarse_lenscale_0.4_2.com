...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.4_2',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.4_2',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a468.rcac.purdue.edu', 'brown-a468', '172.18.34.8'),
    'mp_host_list':(('brown-a468.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
