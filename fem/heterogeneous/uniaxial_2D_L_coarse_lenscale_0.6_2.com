...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.6_2',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.6_2',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a377.rcac.purdue.edu', 'brown-a377', '172.18.33.172'),
    'mp_host_list':(('brown-a377.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
