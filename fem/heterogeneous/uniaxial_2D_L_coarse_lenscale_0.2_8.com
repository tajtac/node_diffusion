...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.2_8',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.2_8',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a515.rcac.purdue.edu', 'brown-a515', '172.18.34.55'),
    'mp_host_list':(('brown-a515.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
