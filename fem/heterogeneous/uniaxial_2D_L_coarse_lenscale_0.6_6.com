...
options = {
    ...
    'input':'uniaxial_2D_L_coarse_lenscale_0.6_6',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'uniaxial_2D_L_coarse_lenscale_0.6_6',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a376.rcac.purdue.edu', 'brown-a376', '172.18.33.171'),
    'mp_host_list':(('brown-a376.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
