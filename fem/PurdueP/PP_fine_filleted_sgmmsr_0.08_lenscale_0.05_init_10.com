...
options = {
    ...
    'input':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.05_init_10',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.05_init_10',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a085.rcac.purdue.edu', 'brown-a085', '172.18.32.135'),
    'mp_host_list':(('brown-a085.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
