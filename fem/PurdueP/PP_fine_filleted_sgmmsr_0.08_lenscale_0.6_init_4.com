...
options = {
    ...
    'input':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.6_init_4',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.6_init_4',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a194.rcac.purdue.edu', 'brown-a194', '172.18.32.244'),
    'mp_host_list':(('brown-a194.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
