...
options = {
    ...
    'input':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.1_init_4',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.1_init_4',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a322.rcac.purdue.edu', 'brown-a322', '172.18.33.117'),
    'mp_host_list':(('brown-a322.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
