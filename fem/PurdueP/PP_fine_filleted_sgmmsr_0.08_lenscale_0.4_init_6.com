...
options = {
    ...
    'input':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.4_init_6',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.4_init_6',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a193.rcac.purdue.edu', 'brown-a193', '172.18.32.243'),
    'mp_host_list':(('brown-a193.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
