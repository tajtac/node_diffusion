...
options = {
    ...
    'input':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.3_init_7',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.3_init_7',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a249.rcac.purdue.edu', 'brown-a249', '172.18.33.44'),
    'mp_host_list':(('brown-a249.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
