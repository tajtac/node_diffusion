...
options = {
    ...
    'input':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.6_init_5',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.6_init_5',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a191.rcac.purdue.edu', 'brown-a191', '172.18.32.241'),
    'mp_host_list':(('brown-a191.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
