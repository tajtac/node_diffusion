...
options = {
    ...
    'input':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.1_init_1',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_sgmmsr_0.08_lenscale_0.1_init_1',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a321.rcac.purdue.edu', 'brown-a321', '172.18.33.116'),
    'mp_host_list':(('brown-a321.rcac.purdue.edu', 4),),
    'mp_mode':MPI,
