...
options = {
    ...
    'input':'PP_fine_filleted_homogeneous_stiff',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'PP_fine_filleted_homogeneous_stiff',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'mp_head_node':('brown-a059.rcac.purdue.edu', 'brown-a059', '172.18.32.109'),
    'mp_host_list':(('brown-a059.rcac.purdue.edu', 5),),
    'mp_mode':MPI,
