...
C      implicit none
     ...
     $      props(nprops)
      ...
      real*8 w1, w2, w3, w4, w5, w6, theta, Psi1_bias, Psi2_bias,
     *       I1, I2, Iv, Iw
...
C     Debugigng 
      ...
      ind = 4+nlayers + 4 + weight_count*10 + (nlayers-1)
      ...
      ind = 4+nlayers + 4 + weight_count*10 + (nlayers-1) + 6
      theta     = props(ind+1)
      Psi1_bias = props(ind+2)
      Psi2_bias = props(ind+3)


! ========== Start loading heterogeneous properties ============
      ...
      ! w3 = sigmoid(w3)
      ! w6 = sigmoid(w6)
! ========== End loading heterogeneous properties ============
...
C     Debugging
      ...
      Psi11 = Psi11/I1_factor
      Psi22 = Psi22/I2_factor
      Psivv = Psivv/Iv_factor
      Psiww = Psiww/Iw_factor
      Psi12 = Psi12/I2_factor
      Psi1v = Psi1v/Iv_factor
      Psi1w = Psi1w/Iw_factor
      Psi2v = Psi2v/Iv_factor
      Psi2w = Psi2w/Iw_factor
      Psivw = Psivw/Iw_factor
